...
| :----- | :----------------------------------------------------- | :-------------------------------------------------------- | :----------------------------------------------------------------- | :------------ |
| F1.1.0 | **Registrering:** Skapa nytt elevkonto.                | Kontot skapas, lösenordet hashas, omdirigeras till login. | Kontot skapas, lösenordet hashas, omdirigeras **inte** till login. | ❌ Ej godkänd |
| F1.1.1 | **Registrering:** Skapa nytt elevkonto (Omtest).       | Kontot skapas, meddelande visas ELLER omdirigering sker.  | _(Väntar på fix)_                                                  | _(Ej utförd)_ |
| F1.2.0 | **Registrering:** Ange upptaget användarnamn.          | Felmeddelande på svenska visas.                           | "Username already exists." (Engelska).                             | ❌ Ej godkänd |
| F1.2.1 | **Registrering:** Ange upptaget användarnamn (Omtest). | Felmeddelande på svenska visas.                           | _(Väntar på fix)_                                                  | _(Ej utförd)_ |
| F1.3.0 | **Registrering:** Ange upptagen e-post.                | Felmeddelande visas på svenska ("E-post upptagen").       | "Email already exists." (Engelska).                                | ❌ Ej godkänd |
| F1.3.1 | **Registrering:** Ange upptagen e-post (Omtest).       | Felmeddelande visas på svenska.                           | _(Väntar på fix)_                                                  | _(Ej utförd)_ |
| F1.4   | **Login:** Logga in med Användarnamn.                  | Inloggning lyckas, omdirigeras till Dashboard.            | Fungerar korrekt.                                                  | ✅ Godkänd    |
| F1.5   | **Login:** Logga in med E-post.                        | Inloggning lyckas, omdirigeras till Dashboard.            | Fungerar korrekt.                                                  | ✅ Godkänd    |
| F1.6   | **Login:** Felaktigt lösenord.                         | Felmeddelande visas, ingen inloggning.                    | Felmeddelande visas.                                               | ✅ Godkänd    |
| F1.7   | **Logout:** Klicka på "Logga ut".                      | Sessionen avslutas, skickas till Login-sidan.             | Fungerar korrekt.                                                  | ✅ Godkänd    |
...
| S4  | **Behörighet**    | Gå till admin_dashboard.php som elev. | Omdirigerad.          | ✅ Säker |
...
| :-- | :---------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- | :------ |
| B1  | **Bug**     | **Raderad Lärare:** Om en lärare raderas, sätts t_teacher_fk till NULL på deras uppgifter. Dessa uppgifter syns då inte i filtret "Visa Bara Mina" för någon admin, och kan bli svåra att hitta. | Låg       | Öppen   |
