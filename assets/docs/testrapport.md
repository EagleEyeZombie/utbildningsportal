...
| ID | Testbeskrivning | Förväntat Resultat | Faktiskt Resultat | Status | Datum |
| :---- | :---- | :---- | :---- | :---- | :---- |
...
| ID | Testbeskrivning | Förväntat Resultat | Faktiskt Resultat | Status | Datum |
| :---- | :---- | :---- | :---- | :---- | :---- |
| F2.1 | **Visning:** Välkomstpanel & Stats. | Namn, XP och Level visas korrekt. | Visas korrekt. | ✅ Godkänd | 19.11.2025 |
| F2.2 | **Listning:** Visa uppgifter. | Alla uppgifter visas som kort. | Alla uppgifter syns. | ✅ Godkänd | 19.11.2025 |
| F2.3 | **Filter:** Filtrera på "Flervalsfrågor". | Endast Flervals-uppgifter visas. | Filtrering fungerar. | ✅ Godkänd | 19.11.2025 |
| F2.4 | **Filter:** Filtrera på "Sortering". | Endast Sorterings-uppgifter visas. | Filtrering fungerar. | ✅ Godkänd | 19.11.2025 |
| F2.5 | **Progression:** Låsta kapitel. | Kapitel med högre nivå än upplåst ska vara gråa/oklickbara. | Lås-ikon visas, knappen inaktiv. | ✅ Godkänd | 19.11.2025 |
...
| F3.4 | **Rättning:** \< 70% rätt. | "Försök igen", inga XP delas ut. | Rättar korrekt. | ✅ Godkänd | 19.11.2025 |
| F3.5 | **Rättning:** \> 70% rätt. | "Bra jobbat", XP sparas i DB. | Rättar korrekt. | ✅ Godkänd | 19.11.2025 |
